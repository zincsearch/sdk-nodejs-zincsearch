...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZincSearchSDK.MetaSearchResponse();
  });
  ...
  describe('MetaSearchResponse', function() {
    it('should create an instance of MetaSearchResponse', function() {
      // uncomment below and update the code to test MetaSearchResponse
      //var instance = new ZincSearchSDK.MetaSearchResponse();
      //expect(instance).to.be.a(ZincSearchSDK.MetaSearchResponse);
    });

    it('should have the property shards (base name: "_shards")', function() {
