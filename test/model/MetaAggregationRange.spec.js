...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZincSearchSDK.MetaAggregationRange();
  });
  ...
  describe('MetaAggregationRange', function() {
    it('should create an instance of MetaAggregationRange', function() {
      // uncomment below and update the code to test MetaAggregationRange
      //var instance = new ZincSearchSDK.MetaAggregationRange();
      //expect(instance).to.be.a(ZincSearchSDK.MetaAggregationRange);
    });
