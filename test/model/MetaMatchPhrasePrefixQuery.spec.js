...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZincSearchSDK.MetaMatchPhrasePrefixQuery();
  });
  ...
  describe('MetaMatchPhrasePrefixQuery', function() {
    it('should create an instance of MetaMatchPhrasePrefixQuery', function() {
      // uncomment below and update the code to test MetaMatchPhrasePrefixQuery
      //var instance = new ZincSearchSDK.MetaMatchPhrasePrefixQuery();
      //expect(instance).to.be.a(ZincSearchSDK.MetaMatchPhrasePrefixQuery);
    });
