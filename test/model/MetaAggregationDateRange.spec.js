...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZincSearchSDK.MetaAggregationDateRange();
  });
  ...
  describe('MetaAggregationDateRange', function() {
    it('should create an instance of MetaAggregationDateRange', function() {
      // uncomment below and update the code to test MetaAggregationDateRange
      //var instance = new ZincSearchSDK.MetaAggregationDateRange();
      //expect(instance).to.be.a(ZincSearchSDK.MetaAggregationDateRange);
    });
