...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZincSearchSDK.MetaFuzzyQuery();
  });
  ...
  describe('MetaFuzzyQuery', function() {
    it('should create an instance of MetaFuzzyQuery', function() {
      // uncomment below and update the code to test MetaFuzzyQuery
      //var instance = new ZincSearchSDK.MetaFuzzyQuery();
      //expect(instance).to.be.a(ZincSearchSDK.MetaFuzzyQuery);
    });
