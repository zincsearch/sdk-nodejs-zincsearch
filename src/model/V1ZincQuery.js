...
import V1QueryHighlight from './V1QueryHighlight';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('highlight')) {
                obj['highlight'] = V1QueryHighlight.constructFromObject(data['highlight']);
            }
...
/**
 * @member {module:model/V1QueryHighlight} highlight
 */
