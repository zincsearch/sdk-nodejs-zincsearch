...
export default class Index {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the addOrRemoveESAlias operation.
     * @callback module:api/Index~addOrRemoveESAliasCallback
     ...
     * @param {module:api/Index~addOrRemoveESAliasCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    addOrRemoveESAlias(callback) {
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the getESAliases operation.
     * @callback module:api/Index~getESAliasesCallback
     * @param {String} error Error message, if any.
     * @param {Object} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/Index~getESAliasesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    getESAliases(target, targetAlias, callback) {
      let postBody = null;
      // verify the required parameter 'target' is set
      if (target === undefined || target === null) {
        throw new Error("Missing the required parameter 'target' when calling getESAliases");
      }
      // verify the required parameter 'targetAlias' is set
      if (targetAlias === undefined || targetAlias === null) {
        throw new Error("Missing the required parameter 'targetAlias' when calling getESAliases");
      }
      ...
      let returnType = Object;
      return this.apiClient.callApi(
        '/es/{target}/_alias/{target_alias}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * @callback module:api/Index~getIndexCallback
     * @param {String} error Error message, if any.
     * @param {Object} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Get index metadata
     * @param {String} index Index
     * @param {module:api/Index~getIndexCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    getIndex(index, callback) {
      ...
      // verify the required parameter 'index' is set
      if (index === undefined || index === null) {
        throw new Error("Missing the required parameter 'index' when calling getIndex");
      }
