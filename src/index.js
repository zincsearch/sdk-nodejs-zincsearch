...
import MetaIndexShard from './model/MetaIndexShard';
...
import V1AggregationBucket from './model/V1AggregationBucket';
...
import V1AggregationResponse from './model/V1AggregationResponse';
import V1Hit from './model/V1Hit';
import V1Hits from './model/V1Hits';
import V1QueryHighlight from './model/V1QueryHighlight';
import V1QueryParams from './model/V1QueryParams';
import V1SearchResponse from './model/V1SearchResponse';
import V1Total from './model/V1Total';
...
/**
* Zinc_Search_engine_API_documents_https__docs_zincsearch_com.<br>
...
export {
    ...
    /**
     * The CoreIndex model constructor.
     * @property {module:model/CoreIndex}
     */
    CoreIndex,
    ...
    /**
     * The MetaIndexShard model constructor.
     * @property {module:model/MetaIndexShard}
     */
    MetaIndexShard,
    ...
    /**
     * The V1AggregationBucket model constructor.
     * @property {module:model/V1AggregationBucket}
     */
    V1AggregationBucket,
    ...
    /**
     * The V1AggregationResponse model constructor.
     * @property {module:model/V1AggregationResponse}
     */
    V1AggregationResponse,

    /**
     * The V1Hit model constructor.
     * @property {module:model/V1Hit}
     */
    V1Hit,

    /**
     * The V1Hits model constructor.
     * @property {module:model/V1Hits}
     */
    V1Hits,

    /**
     * The V1QueryHighlight model constructor.
     * @property {module:model/V1QueryHighlight}
     */
    V1QueryHighlight,
    ...
    /**
     * The V1SearchResponse model constructor.
     * @property {module:model/V1SearchResponse}
     */
    V1SearchResponse,

    /**
     * The V1Total model constructor.
     * @property {module:model/V1Total}
     */
    V1Total,
